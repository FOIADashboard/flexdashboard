...
# Load the data. The data should be saved in the data/rds and
...
radioButtons(
  ...
  #             "Budgets Ratio and Backlogged Requests" = "Budget vs Backlog", 
  #             "Public Affairs vs Budget"),
...
# budget
filtered_input_b <- reactive(paste0(component_b(), "_budget"))
